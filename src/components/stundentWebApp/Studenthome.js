...
const StudentHome=()=>{
    ...
    const [completedQuizpage,setCompletedQuizpage]=useState(null);
    ...
    const renderContent = () => {
        switch (currentPage) {
          ...
          case 'Studentquiz':
            return <Studentquiz takequiz={setCurrentPage} setCompletedQuizpage={setCompletedQuizpage}/>;
          case 'take-quiz':
            return <QuizPage />;  
          case 'completed-quiz'  :
            return  <SubmittedQuizPage completedQuizpage={completedQuizpage}/>;
          case 'Studentlibrary':
